...
class PoliciesAnnexes extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('policies_annexes', function (Blueprint $table) {
            $table->bigIncrements('id_policies_annexes');
    ...
    {
        Schema::dropIfExists('policies_annexes');
    }
}
