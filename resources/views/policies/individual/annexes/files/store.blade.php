<div class="card shadow mb-4 hidden" id="cuadro2">
  ...
  <div class="card-body">
      <form class="user" autocomplete="off" method="post" id="store" enctype="multipart/form-data">
        ...
        <!---END ROW-->
        <input type="hidden" name="tabla" value="policies_annexes">
        <input type="hidden" name="destinationPath" value="img/policies/annexes">
        <input type="hidden" name="id_register" value="{{$id_policies_annexes}}">
