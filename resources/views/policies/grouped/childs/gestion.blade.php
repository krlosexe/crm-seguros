			...
			<div class="main-content">
				...
				<div class="container-fluid" id="cuadro1">
					<div class="page-title">
						<h4>Gestión de Polizas Hijas.</h4>
					</div>
					<div class="row">
				...
				@include('policies.grouped.childs.store')
				@include('policies.grouped.childs.view')
				@include('policies.grouped.childs.edit')
...
<script>
			...
			function store(){
				enviarFormulario("#store", 'api/policies-childs/', '#cuadro2');
			}
			...
			function list(cuadro) {
				...
				var table=$("#table").DataTable({
					...
					"ajax":{
						"method":"GET",
						 "url":''+url+'/api/policies-childs/'+{{$id_policies}},
						 "data": {
							"id_user": id_user,
							"token"  : tokens,
						},
					...
					"buttons": buttonsDatatable({
						title: 'Polizas Hijas - Agrupadas',
						filename: 'polizas-hijas-agrupadas',
