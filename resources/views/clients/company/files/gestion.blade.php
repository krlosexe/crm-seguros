    ...
    <div id="content-wrapper" class="layout">
       ...
       <div class="page-container" style="padding-left: 0px">
			<div class="main-content">
				...
				@include('clients.company.files.store')
				@include('clients.company.files.view')
				@include('clients.company.files.edit')
...
<script>
			...
			function list(cuadro) {
				...
				var table=$("#table").DataTable({
					...
					"ajax":{
						"method":"GET",
						"url":''+url+'/api/files/clients_company/'+{{$id_client}},
						 "data": {
							"id_user": id_user,
							"token"  : tokens,
						},
					...
					"buttons": buttonsDatatable({
						title: 'Digitales - Empresas',
						filename: 'digitales-empresas',
						columns: [0, 1, 2],
					}),
					initComplete(){
