    ...
    <div id="content-wrapper" class="layout">
       ...
       <div class="page-container" style="padding-left: 0px">
			<div class="main-content">
				...
				@include('configuracion.Company.files.store')
				@include('configuracion.Company.files.view')
				@include('configuracion.Company.files.edit')
			...
			function list(cuadro) {
				...
				var table=$("#table").DataTable({
					...
					"buttons": buttonsDatatable({
						title: 'Digitales de Compañias',
						filename: 'digitales-companias',
						columns: [0, 1],
					}),
					initComplete(){
