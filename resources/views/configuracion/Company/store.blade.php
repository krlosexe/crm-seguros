	  	...
	  	<form class="user" autocomplete="off" method="post" id="store" enctype="multipart/form-data">
			...
			<ul class="nav nav-pills" role="tablist">
				...
				<li class="nav-item remove-pay">
					<a href="#default-tab-2-0" class="nav-link" role="tab" data-toggle="tab" aria-selected="false">Digitales</a>
				</li>
			</ul>
			<br>
			<br>
			...
			<div class="tab-content">
				...
				<div role="tabpanel" class="tab-pane fade in active show" id="default-tab-1-0">
					<br><br>	<center><h4>Actualizar información de la Empresa</h4></center> 	<br><br>	<br><br>
