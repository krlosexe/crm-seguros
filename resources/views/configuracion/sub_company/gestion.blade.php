@extends('layouts.app')
		 ...
		 <div class="main-content">
			<div class="container-fluid" id="cuadro1">
				<div class="page-title">
					<h4>Gestión de Tipos Sub Compañias.</h4>
				</div>
				<div class="row">
			...
			@include('configuracion.sub_company.store')
			@include('configuracion.sub_company.view')
			@include('configuracion.sub_company.edit')
	...
	@section('CustomJs')
		...
		<script>
			...
			function update(){
				enviarFormularioPut("#form-update", 'api/sub/company', '#cuadro4', false, "#avatar-edit");
			}


			function store(){
				enviarFormulario("#store", 'api/sub/company', '#cuadro2');
			}
			...
			*/
			function edit(tbody, table){
				$(tbody).on("click", "span.editar", function(){
					...
					$("#id_edit").val(data.id_type_sub_company)
			...
			*/
			function desactivar(tbody, table){
				$(tbody).on("click", "span.desactivar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status/sub/company/'+data.id_type_sub_company+"/"+2,"¿Está seguro de desactivar el registro?", 'desactivar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			*/
			function activar(tbody, table){
				$(tbody).on("click", "span.activar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status/sub/company/'+data.id_type_sub_company+"/"+1,"¿Está seguro de desactivar el registro?", 'activar');
				});
			}
			...
			function eliminar(tbody, table){
				$(tbody).on("click", "span.eliminar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status/sub/company/'+data.id_type_sub_company+"/"+0,"¿Esta seguro de eliminar el registro?", 'Eliminar');
				});
			}
		</script>
	@endsection
