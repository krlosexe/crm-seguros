    ...
    <div id="content-wrapper" class="layout">
       ...
       <div class="page-container" style="padding-left: 0px">
			<div class="main-content">
				...
				@include('configuracion.insurers.files.store')
				@include('configuracion.insurers.files.view')
				@include('configuracion.insurers.files.edit')
...
<script>
			...
			function list(cuadro) {
				...
				var table=$("#table").DataTable({
					...
					"ajax":{
						"method":"GET",
						 "url":''+url+'/api/files/insurers/'+{{$id_insurers}},
						 "data": {
							"id_user": id_user,
							"token"  : tokens,
						},
					...
					"buttons": buttonsDatatable({
						title: 'Digitales de Aseguradoras',
						filename: 'digitales-aseguradoras',
						columns: [0, 1],
					}),
					initComplete(){
			...
			*/
			function ver(tbody, table){
				...
				$(tbody).on("click", "span.consultar", function(){
					...
					$('#input-file-view').fileinput('destroy').val('').val('');
					var url=document.getElementById('ruta').value; 
